...
func handle_movement() -> State:
	...
	if movement_vector != Vector2.ZERO:
		# Read config
		var tile_aspect: Vector2 = ConfigProvider.game_config.tile_aspect
		...
		# Read configs
		var move_speed := ConfigProvider.player_config.move_speed
		var acceleration := ConfigProvider.player_config.acceleration
